...
export default function Home() {
  ...
  return (
    ...
    <div className='flex min-h-[100vh] items-center justify-center p-[16px]'>
      <div className='w-[100%] max-w-[400px] bg-white rounded-[16px] overflow-hidden'>
        <div className='p-[16px] text-right bg-gray-900 text-gray-300 text-[24px] font-[500]'>
        ...
        <div className='flex flex-wrap font-bold'>
          ...
          <button onClick={() => calculate()} className='appearance-none border-0 outline-0 text-gray-300 text-[20px] p-[16px] cursor-pointer transition-[0.4s] hover:opacity-[0.9] flex-2 max-w-[33.333%] bg-gray-900'>=</button>
        </div>
      </div>
    </div>
    </div>
